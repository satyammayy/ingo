...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M, { joined }) => __awaiter(this, void 0, void 0, function* () {
            ...
            return void M.reply(yield request_1.default.buffer(`https://shot.screenshotapi.net/screenshot?&url=${url}&full_page=true&fresh=true&output=image&file_type=png&wait_for_event=load`), baileys_1.MessageType.image, undefined, undefined, `🌟 Here you go.\n`, undefined).catch((reason) => M.reply(`✖ An error occurred. Please try again later. ${reason}`));
        });
    }
}
